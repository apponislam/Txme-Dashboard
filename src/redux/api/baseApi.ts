...
export const baseApi = createApi({
    ...
    tagTypes: ["Auth", "User", "Dashboard", "LostItem", "Shipping", "Public", "Review", "Settings", "TermsAndConditions", "Transactions", "Admins", "Users", "Services", "AdminChats", "Messages", "Promotion"],
    endpoints: () => ({}),
});
