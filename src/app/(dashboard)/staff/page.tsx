...
const StaffManagement = () => {
    ...
    const activeStaff = allAdmins.filter((admin: Admin) => admin.status === "active").length;
    const inactiveStaff = allAdmins.filter((admin: Admin) => admin.status === "inactive").length;
