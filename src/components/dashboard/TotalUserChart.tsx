...
//                             <Line dataKey="provider" type="linear" stroke="#FF5A36" strokeWidth={2} dot={false} activeDot={{ r: 2 }} />
//                             <Line dataKey="customer" type="linear" stroke="#A0BCE8" strokeWidth={2} strokeDasharray="3 3" dot={false} activeDot={{ r: 2 }} />
//                         </LineChart>
//                     </ChartContainer>
//                 </div>
//             </CardContent>
